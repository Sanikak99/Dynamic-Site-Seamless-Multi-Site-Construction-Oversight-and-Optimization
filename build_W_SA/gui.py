...
button_1 =tk.Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda:display_excel_on_canvas(canvas, r"C:\Users\Sanika\Documents\Project II\build_W_SA\SU_SANGLI.xlsx"),
    relief="flat"
)
...
button_3 = tk.Button(
    ...
    bg="#21fef4",  # Change background color to green
    fg="black",  # Change text color to white
    borderwidth=2,  # Add borderwidth for 3D effect
    relief="raised",  # Use "raised" relief for 3D effect
    command=lambda: open_excel_sheet(r"C:\Users\Sanika\Documents\Project II\build_W_SA\SU_SANGLI.xlsx")
)
button_3.place(x=600.0, y=650.0, width=250, height=90)

button_4 = tk.Button(
    text="Edit Sheet W",
    font=("Helvetica", 25),  # Adjust font size
    bg="#b6e42c",  # Change background color to green
    fg="black",  # Change text color to white
    borderwidth=2,  # Add borderwidth for 3D effect
    relief="raised",  # Use "raised" relief for 3D effect
    command=lambda:open_excel_sheet(r"C:\Users\Sanika\Documents\Project II\build_W_SA\W_SANGLI.xlsx")
)
button_4.place(x=1000.0, y=650.0, width=250, height=90)
